  ...
  return (
    <div className="overflow-x-auto">
      <div className="tabs tabs-border flex">
        <input type="radio" name="user_page_tabs" className="tab flex-auto" aria-label="ツイート" onClick={()=>setActive(0)} defaultChecked />
        ...
        <input type="radio" name="user_page_tabs" className="tab flex-auto" aria-label="ツイートと返信" onClick={()=>setActive(1)} />
        <div className="tab-content">
          { active === 1 && (
            <Suspense>
        ...
        <input type="radio" name="user_page_tabs" className="tab flex-auto" aria-label="いいね" onClick={()=>setActive(2)} />
        <div className="tab-content">
          { active === 2 && (
            <Suspense>
